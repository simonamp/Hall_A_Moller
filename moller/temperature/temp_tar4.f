...
C
      ...
      PARAMETER (mxx=75,mxy=15,mxt=100000,mxbeam=400000)
      PARAMETER (mxdx=20,mxdcx=2,mxdy=20,mxdcy=2)
...
C
      ...
      IF(iost.EQ.0) THEN
         READ(9,*) TIM,bcurr,rb,ang,zsiz,fradiat,dtv
         CLOSE(9)
